...
export class AdditionalDriverComponent implements OnInit, OnChanges {
  @Input() driver: Driver;
  @Input() index;
  ...
  constructor(private _inquiryService: InquiryService, private _localizationService: LocalizationService) {
    this.childrenCount = [];
  ...
  */
  checkIdValidation(): boolean {
    ...
    let nin = this.driver.nationalId ? this.driver.nationalId.toString() : '';
    nin = nin.trim();
