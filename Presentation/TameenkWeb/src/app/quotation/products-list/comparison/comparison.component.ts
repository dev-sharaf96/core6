...
import { LocalizationService, IProduct } from 'src/app/core';
...
export class ComparisonComponent implements OnInit {
  ...
  benefitsList = [
    ...
    },
    {
      code: 13,
      description: '',
      englishDescription: 'Comprehensive Coverage up to 10,000 SR',
      arabicDescription: 'تغطية شاملة حتى 10.000 ريال سعودى',
      logo: 'theft-fire-frontglass'
    },
  ];
  ...
  changeSelected(productIndex, benefitIndex) {
    ...
    // this.onBenefitChange.emit(benefitValue);
  }
}
