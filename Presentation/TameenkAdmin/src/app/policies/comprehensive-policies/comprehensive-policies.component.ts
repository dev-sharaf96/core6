...
import { ComprehensivePolicies } from './ComprehensivePolicies';
import { PolicyListing } from '../policies-listing';
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: 'app-comprehensive-policies',
  templateUrl: './comprehensive-policies.component.html',
  styleUrls: ['./comprehensive-policies.component.css']
})
export class ComprehensivePoliciesComponent implements OnInit {

  policiesFilter: ComprehensiveFilter;
  ...
  constructor(
    ...
    showDetails(Policy: ComprehensivePolicies) {
    ...
    SuccessPoliciesLazyLoad(event) {
      ...
      this.loading = true;
      this._adminPolicyService.getComprehinsivePolicyWithFilter(this.policiesFilter,
