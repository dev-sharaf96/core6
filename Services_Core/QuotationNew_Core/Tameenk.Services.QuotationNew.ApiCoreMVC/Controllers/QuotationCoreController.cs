...
namespace Tameenk.Services.QuotationNew.ApiCore.Controllers
{
    ...
    [ApiController]
    public class QuotationCoreController : ControllerBase
    {
        ...
        public QuotationCoreController(IAsyncQuotationContext asyncQuotationContext)
        {
            _asyncQuotationContext = asyncQuotationContext;
        }

        // GET: api/<QuotationCoreController>
        //[HttpGet]
        ...
        //    Guid parentRequestId = Guid.NewGuid();//"b69b45d1-fbe6-480c-8898-6bf12049cf61";
        ...
        //    string currentUserId = null;// _authorizationService.GetUserId(User);
        ...
        //        var quotationResponseCache = await _asyncQuotationContext.GetFromQuotationResponseCache(insuranceCompanyId, insuranceTypeCode, qtRqstExtrnlId, vehicleAgencyRepair, null, selectedUserId);
        ...
        //                selectedUserId, currentUserName, log, excutionStartDate, parentRequestId, insuranceTypeCode, vehicleAgencyRepair, null, null, null, null, false);
        //        if (quotationOutput == null)
        //            return Ok("No Product to show");
        //        if (quotationOutput.ErrorCode != QuotationNewOutput.ErrorCodes.Success)
        //            return Ok(quotationOutput.ErrorDescription);
        ...
        //                    if (defaultProduct.DeductableValue != null)
        //                    {
        //                        var deductableProduct = responseModel.Products.Where(a => a.DeductableValue == null).FirstOrDefault();
        ...
        //        _asyncQuotationContext.InsertQuotationResponseIntoInmemoryCache(insuranceCompanyId, insuranceTypeCode, qtRqstExtrnlId, vehicleAgencyRepair, null, selectedUserId, responseModel);
        //        return Ok(responseModel);
        //    }
        //    catch (Exception ex)
        //    {
            ...
            bool OdQuotation = false*/)
        {
            ...
            try
            {
                ...
                if (cacheExist)
                    return (IActionResult)Ok(responseModel);
            ...
            catch (Exception ex)
            {
                ...
                return (IActionResult)Ok(output);
            }
        }
        #endregion
