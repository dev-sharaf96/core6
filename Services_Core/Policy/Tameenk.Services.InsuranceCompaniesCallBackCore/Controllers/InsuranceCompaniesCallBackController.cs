...
namespace Tameenk.Services.InsuranceCompaniesCallBack.Controllers
{
    ...
    public class InsuranceCompaniesCallBackController : ControllerBase
    {
        ...
        public IActionResult PolicyUploadNotification([FromBody] PolicyUploadNotificationModel policyUploadNotificationModel)
        {
            try
            {
        ...
        public IActionResult PolicyAttachments(CommonPolicyRequestModel policyAttachmentModel)
        {
            try
            {
        ...
        public IActionResult GetPolicyRequestAdditionalInfo([FromBody] CommonPolicyRequestModel policyRequestModel)
        {
        ...
        public IActionResult PolicyAttachmentsWithURL(CommonPolicyRequestModel policyAttachmentModel)
        {
            try
            {
                _logger.Log($"CallBack -> PolicyAttachments <<start>> model:{JsonConvert.SerializeObject(policyAttachmentModel)}");
        ...
        [Route("~/UpdatePolicy")]
        public IActionResult UpdateWataniyaPolicyInfo(WataniyaPolicyinfoCallbackRequest callBackRequest)
        {
            try
            {
        ...
        public IActionResult UpdateWataniyaVehicleId(WataniyaUpdateVehicleIdCallbackRequest callBackRequest)
        {
            try
            {
        ...
        public IActionResult CancelPolicyNotification(CancelPolicyNotificationRequest callBackRequest)
        {
            try
            {
