...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class VehicleController : AdminBaseApiController
    {
        ...
        public  IHttpActionResult EditVehicle([FromBody]Models.VehicleModel vehicleModel)
        {
        ...
        [AdminAuthorizeAttribute(pageNumber:9)]
        public IHttpActionResult DeleteVehicle(string vehicleId)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [AdminAuthorizeAttribute(pageNumber: 9)]
        public IHttpActionResult GetAllVehicleBasedOnFilter(VehicleFilterModel vehicleFilterModel,int pageIndex = 0, int pageSize = int.MaxValue, string sortField = "id", bool sortOrder = false)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<Models.VehicleModel>))]
        [AdminAuthorizeAttribute(pageNumber: 9)]
        public IHttpActionResult GetVehicleDetails(string id)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult DeleteVehicleRequests(string sequenceNumber)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult GetVehicleBreakingSystem()
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<string>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetVehicleParkingSensors()
        {
            try
            {
                List<IdNamePairModel> result = new List<IdNamePairModel>();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<string>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetVehicleCameraTypes()
        {
            try
            {
                List<IdNamePairModel> result = new List<IdNamePairModel>();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<string>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetVehicleMakers(string code, string description, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<Tameenk.Services.AdministrationApi.Models.VehicleMakerModel>>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult ExportAllNewServiceRequest(string code, string description)
        {
            try
            {
                if (!string.IsNullOrEmpty(description) && description.Contains("\n"))
        ...
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetVehicleMakerDetailss(int id)
        {
            try
            {
                if (id <= 0)
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<string>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetVehicleMakerModels(int code, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            try
            {
        ...
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult AddNewMakerModel([FromBody]Tameenk.Services.AdministrationApi.Models.VehicleMakerModelsModel model, string action)
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<PolicyOutput>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult AddNewMaker([FromBody]Tameenk.Services.AdministrationApi.Models.VehicleMakerModel model)
        {
            try
            {
        ...
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetMakerModelDetials(int code, int makerCode)
        {
            try
            {
                if (code <= 0)
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<string>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetVehicleMakerModelsWithFilter(string code, string makerCode, string description, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            try
            {
                if (!string.IsNullOrEmpty(description) && description.Contains("\n"))
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<Tameenk.Services.AdministrationApi.Models.VehicleMakerModel>>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult ExportAllMakerModels(string code, string makerCode, string description)
        {
            try
            {
                if (!string.IsNullOrEmpty(description) && description.Contains("\n"))
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<bool>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult CheckMakerCode([FromBody]Tameenk.Services.AdministrationApi.Models.VehicleMakerModel model)
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<bool>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult CheckMakerModelCode([FromBody]Tameenk.Services.AdministrationApi.Models.VehicleMakerModel model)
        {
            try
            {
        ...
        public IHttpActionResult GetVehicleOwnerShip([FromBody] ownerShipVehicleFilterModel ownerShipVehicleFilterModel)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
