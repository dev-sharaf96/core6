...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class MOIController : AdminBaseApiController
    {
        ...
        public IHttpActionResult GetAll(int pageIndex = 0, int pageSize = 10, string sortField = "Id", bool sortOrder = true, int filter = 1, string clientEmail = null)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IList<MOIDetail>>))]
        public IHttpActionResult ChangeStatus(int id, bool approved)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult Delete(int id, bool unSubscribe)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
