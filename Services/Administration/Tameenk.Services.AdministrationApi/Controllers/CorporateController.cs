...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class CorporateController : AdminBaseApiController
    {
        ...
        public IHttpActionResult GetCorporateUsersWithFilter([FromBody]CorporateFilterModel userFilter, int pageIndex = 1, int pageSize = int.MaxValue)
        {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public async Task<IHttpActionResult> RegisterUserAsync([FromBody] CorporateNewUserModel model)
        {
        ...
        public IHttpActionResult LockUser([FromBody] CorporateNewUserModel user)
        {
        ...
        public IHttpActionResult GetCorporateAccounts(string lang = "ar")
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IList<CorporateUserModel>>))]
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public IHttpActionResult GetCorporateAccountsWithFilter([FromBody]CorporateAccountFilter filterModel, int pageIndex = 1, int pageSize = int.MaxValue)
        {
            string name = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public IHttpActionResult AddCorporateAccount([FromBody] CorporateNewAccountModel model)
        {
            Output<RegisterOutput> Output = new Output<RegisterOutput>();
            Output.Result = new RegisterOutput();
            Output.Result.errors = new List<Error>();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public IHttpActionResult GetCorporateAccount(int id)
        {
            string name = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<CorporateAccountModel>))]
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public IHttpActionResult EditCorporateAccount([FromBody] CorporateNewAccountModel model)
        {
            Output<RegisterOutput> Output = new Output<RegisterOutput>();
            Output.Result = new RegisterOutput();
            Output.Result.errors = new List<Error>();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<AdministrationOutput<bool>>))]
        public IHttpActionResult LockCorporateAccount([FromBody] CorporateAccountModel model)
        {
            AdministrationOutput<bool> Output = new AdministrationOutput<bool>();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult AddBalanceToWallet(WalletAddBalanceModel walletAddBalanceModel)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
