...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class InvoiceController : AdminBaseApiController
    {
        ...
        public IHttpActionResult GetAllInvoicesAfterFilters([FromBody] InvoiceFilters invoiceFilter, int pageIndex = 0, int pageSize = int.MaxValue, string sortField = "id", bool sortOrder = false)
        {
            try
            {
        ...
        public IHttpActionResult GetInvoiceFileById(int id)
        {
            try
            {
        ...
        public IHttpActionResult GetAllCommissionAfterFilters(int? companycode, int? producttype, int pageIndex = 0, int pageSize = int.MaxValue, string sortField = "InsuranceTypeCode", bool sortOrder = false)
        {
        ...
        //[AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult UpdateCommission([FromBody] CommissionAndFeesModel model)
        {
            //AdminRequestLog log = new AdminRequestLog();
        ...
        public IHttpActionResult GenerateCommissionAndFeesReportExcel(int? companycode, int? producttype )
        {
            string name = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
