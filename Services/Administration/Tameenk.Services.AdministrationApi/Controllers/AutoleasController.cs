...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class AutoleasController : AdminBaseApiController
    {
        ...
        public IHttpActionResult GetAutoleaseUsersWithFilter([FromBody]AutoleaseFilterModel userFilter, int pageIndex = 0, int pageSize = int.MaxValue)
        {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public async Task<IHttpActionResult> RegisterUserAsync([FromBody] RegisterModel model)
        {
        ...
        public IHttpActionResult Edituser([FromBody] UserUpdateData user)
        {
            Output<RegisterOutput> Output = new Output<RegisterOutput>();
            Output.Result = new RegisterOutput();
            Output.Result.errors = new List<Error>();
        ...
        public IHttpActionResult DeleteUser([FromBody] AutoleaseUserModel user)
        {
        ...
        public IHttpActionResult AddBank([FromBody] Models.BankModel bank)
        {
        ...
        public IHttpActionResult EditBank([FromBody] Models.BankModel bank)
        {
        ...
        public IHttpActionResult GetBanks(string lang = "ar")
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<IdNamePairModel>>))]
        public IHttpActionResult GetInsuranceCompany(string lang = "ar")
        {
            try
            {
