...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class PromotionCodeController : AdminBaseApiController
    {
        ...
        public IHttpActionResult GetPromotionProgramCodes(int pageIndex = 0, int pageSize = int.MaxValue)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<PromotionProgramCodeModel>>))]
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        public IHttpActionResult GetPromotionCodeById(int id)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult EditPromotionCode([FromBody]PromotionProgramCodeModel promotionProgramCodeModel)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<PromotionProgramCodeModel>))]
        public async System.Threading.Tasks.Task<IHttpActionResult> AddPromotionCode([FromBody]PromotionProgramCodeModel promotionProgramModel)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<PromotionProgramCodeModel>>))]
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        public IHttpActionResult GetPromotionProgramCodesByProgramId(int programId ,int pageIndex = 0, int pageSize = int.MaxValue)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
