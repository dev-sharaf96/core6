...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    public class TicketController : AdminBaseApiController
    {
        ...
        public IHttpActionResult GetAllStatus(string lang)
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<ChannelModel>>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetAllTypes(string lang)
        {
            try
            {
        ...
        public IHttpActionResult GetAllTicketsWithFilter(TicketFilterModel filter, int pageIndex = 0, int pageSize = 10, string lang = "En")
        {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost]        [Route("api/ticket/excel")]        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<TicketListingModel>>))]        [AdminAuthorizeAttribute(pageNumber: 43)]        public IHttpActionResult ExportAllNewServiceRequest(TicketFilterModel filter)        {            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
            log.ServerIP = Utilities.GetInternalServerIP();
            log.UserAgent = Utilities.GetUserAgent();
        ...
        [AdminAuthorizeAttribute(pageNumber: 43)]
        public IHttpActionResult GetDetailsToFailPolicyByReferenceId(int id)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetAllTicketHistories(int id)
        {
            try
            {
                string exception = string.Empty;
        ...
        [AdminAuthorizeAttribute(pageNumber: 43)]
        public IHttpActionResult UpdateTicketStatus([FromBody]List<TicketHistoryModel> model, bool isClosed)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<TicketListingModel>>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetAllLogWithFilterNew(TicketLogFilterModel filter, int pageIndex = 0, int pageSize = 10)
        {
            try
            {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<IEnumerable<TicketListingModel>>))]
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult ExportTicketLog(TicketLogFilterModel filter)
        {
            try
            {
                List<TicketLogModel> result = new List<TicketLogModel>();
        ...
        public IHttpActionResult CreateTicket([FromBody]CreateTicketModel createTicketModel)
        {
        ...
        [AdminAuthorizeAttribute(pageNumber: 43)]
        public IHttpActionResult DeleteUserTicketHistory(int historyId)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
