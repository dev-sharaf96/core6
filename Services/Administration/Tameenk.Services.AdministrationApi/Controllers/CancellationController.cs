...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class CancellationController : BaseApiController
    {
        ...
        public IHttpActionResult CancelPolicy([FromBody] CancelVechilePolicyRequestDto request)
        {
        ...
        public IHttpActionResult GetPolicyWithFilterForcancellation([FromBody] PoliciesForCancellationFilterModel policyFilter, int pageIndex = 1, int pageSize = 10, string sortField = "policyIssueDate", bool sortOrder = false)
        {
            string name = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
        ...
        public IHttpActionResult ReasonCodes(string lang = "en")
        {
        ...
        public IHttpActionResult ActivateCancelledPolicy([FromBody] ActivateVechilePolicyRequestDto request)
        {
            AdminRequestLog log = new AdminRequestLog();
            CancellPolicyOutput output = new CancellPolicyOutput();
            try
