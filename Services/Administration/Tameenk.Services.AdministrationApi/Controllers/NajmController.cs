...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class NajmController : AdminBaseApiController
    {
        ...
        public IHttpActionResult DeleteNajmResponse(int id)
        {
        ...
        public IHttpActionResult GetAllNajmResponsesBasedOnFilter(NajmResponseFilterModel najmResponseFilterModel, int pageIndex = 0, int pageSize = int.MaxValue, string sortField = "id", bool sortOrder = false)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult UpdateNajmResponse(NajmResponseModel model)
        {
