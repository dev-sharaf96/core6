...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    public class PromotionController : AdminBaseApiController
    {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        [AdminAuthorizeAttribute(pageNumber: 19)]
        public IHttpActionResult GetUserPromotionPrograms(string useremail,int pageIndex = 0, int pageSize = int.MaxValue)
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        [AdminAuthorizeAttribute(pageNumber: 19)]
        public IHttpActionResult GetAllPromotions(int pageIndex = 0, int pageSize = int.MaxValue)
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        [AdminAuthorizeAttribute(pageNumber: 19)]
        public IHttpActionResult GetPromotionProgramById(int id)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [AdminAuthorizeAttribute(pageNumber: 19)]
        public async System.Threading.Tasks.Task<IHttpActionResult> AddPromotion([FromBody]PromotionProgramModel promotionProgramModel)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        [AdminAuthorizeAttribute(pageNumber: 19)]
        public async System.Threading.Tasks.Task<IHttpActionResult> UpdatePromotion([FromBody]PromotionProgramModel promotionProgramModel)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult GetPromotionDiscountsWithFilter([FromBody]PromotionDiscountModel model, int pageIndex = 0, int pageSize = int.MaxValue)
        {
        ...
        [AdminAuthorizeAttribute(pageNumber: 6)]
        public IHttpActionResult ExportPromotionDiscounts([FromBody]PromotionDiscountModel model, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            string name = System.Threading.Thread.CurrentThread.CurrentCulture.Name;
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
        ...
        [AdminAuthorizeAttribute(pageNumber: 6)]
        public IHttpActionResult DeleteDeservingOffers(int id)
        {
        ...
        [AdminAuthorizeAttribute(pageNumber: 6)]
        public IHttpActionResult UploadOffersSheet([FromBody]FileModel file)
        {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Api.Core.Models.ErrorModel>))]
        [AdminAuthorizeAttribute(pageNumber: 19)]
        public IHttpActionResult GetPromotionProgramNinsByProgramId(int id, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult DeleteNinFromPromotinProgram(int rowId)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        [AdminAuthorizeAttribute(pageNumber: 63)]
        public IHttpActionResult GetAllApromotionApprovalsWithFilter([FromBody]PromotionProgramApprovalsFilterModel filterModel, int pageIndex = 1, int pageSize = 10)
        {
        ...
        public IHttpActionResult ApprovePromotionApproval([FromBody]PromotionProgramApprovalActionModel model)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<bool>))]
        //[AdminAuthorizeAttribute(pageNumber: 36)]
        public IHttpActionResult DeletePromotionApproval([FromBody]PromotionProgramApprovalActionModel model)
        {
            AdministrationOutput<bool> Output = new AdministrationOutput<bool>();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<string>))]
        public IHttpActionResult GetImage(int id, string lang)
        {
