...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    public class WareefController : AdminBaseApiController
    {
        ...
        public IHttpActionResult AddWareef([FromBody] WareefModel model)
        {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult EditWareef([FromBody] WareefModel model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult DeleteWareef([FromBody] WareefModel model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult AddCategory([FromBody] WareefCategoryModel model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult EditCategory([FromBody] WareefCategoryModel model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult DeleteCategory([FromBody] DeleteCategoryModel model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult AddWareefDiscount([FromBody] WareefDiscountBenefits model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult EditWareefDiscount([FromBody] WareefDiscountBenefits model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult DeleteDiscount(DeleteDiscountBenefitModel model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult AllDiscounts()
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult AllDiscountDetails(int discountId)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult GetCategoryPartners(int categoryId)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult PartnerDiscounts(int partnerId)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult DiscountBenfitsDescription(int DiscountId)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<Tameenk.Api.Core.Models.ErrorModel>))]
        public IHttpActionResult EditDiscountBenefitDescription([FromBody] List<WareefDiscountBenefit> model)
        {
            var output = new WareefOutput();
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
        ...
        public IHttpActionResult UploadWareefDiscountSheet([FromBody] FileModel file)
        {
