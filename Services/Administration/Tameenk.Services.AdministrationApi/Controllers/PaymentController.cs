...
namespace Tameenk.Services.AdministrationApi.Controllers
{
    ...
    public class PaymentController : AdminBaseApiController
    {
        ...
        public IHttpActionResult ReProcessFailPayment(HyperPayResponseModel hyperPayResponseModel)
        {
        ...
        public IHttpActionResult GetDetailsOfFailPayment(string referenceId)
        {
            try
            {
        ...
        [AdminAuthorizeAttribute(pageNumber: 0)]
        public IHttpActionResult GetAllFailAndPendingPayment(PaymentFilterModel filter, int pageIndex = 0, int pageSize = int.MaxValue, string sortField = "InvoiceDate", bool sortOrder = false)
        {
            try
            {
                int count = 0;
        ...
        public IHttpActionResult GetAllEdaatNotificationPayment(EdaatFilterModel filter, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            DateTime dtBeforeCalling = DateTime.Now;
            AdminRequestLog log = new AdminRequestLog();
            log.UserIP = Utilities.GetUserIPAddress();
