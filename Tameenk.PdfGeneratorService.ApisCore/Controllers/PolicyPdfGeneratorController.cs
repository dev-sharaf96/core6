...
namespace Tameenk.PdfGeneratorService.Api.Controllers
{
    ...
    public class PolicyPdfGeneratorController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] ReportGenerationModel reportGenerationData)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GeneratePdfTemplate([FromBody] ReportGenerationModel reportGenerationData)
        {
            IPdfGeneratorServices pdfGeneratorServices = new PdfGeneratorServices();
            try
            {
