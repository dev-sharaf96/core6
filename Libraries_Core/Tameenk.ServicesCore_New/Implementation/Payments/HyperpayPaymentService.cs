...
//                //var jsonSerializer = new Json.Serialization.JavaScriptSerializer();
//                string json = JsonConvert.SerializeObject(payOut);
...
//                hyperpayRequest.ServiceRequest = JsonConvert.SerializeObject(data);
//                hyperpayRequestRepository.Insert(hyperpayRequest);
