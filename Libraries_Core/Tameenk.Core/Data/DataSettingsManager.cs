...
namespace Tameenk.Core.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        public DataSettingsManager(IWebHostEnvironment webHostEnvironment)
        {
        ...
        private string MapPath(string path)
        {
            if (_webHostEnvironment.IsDevelopment() || _webHostEnvironment.IsStaging() || _webHostEnvironment.IsProduction())
            {
                // Adjust the logic based on your needs
                return Path.Combine(_webHostEnvironment.ContentRootPath, path);
            }

            // Handle other environments or non-hosted scenarios
            return path;
        }
    }
}
