...
namespace Tameenk.Integration.Providers.Solidarity
{
    public class SolidarityInsuranceProvider : RestfulInsuranceProvider
    {
        ...
        private const string QUOTATION_TPL_URL = "https://localhost:7267/BcareMotorApi/Quotation";// "https://bcare.solidaritytakaful.com/BcareMotorApi/Quotation";
        private const string QUOTATION_COMPREHENSIVE_URL = "https://localhost:7267/BcareMotorApi/Quotation";// "https://bcare.solidaritytakaful.com/BcareMotorApi/Quotation";
