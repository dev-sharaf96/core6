...
namespace Tameenk.Integration.Providers.AICC
{
    public class AICCInsuranceProvider : RestfulInsuranceProvider
    {
        ...
        private const string QUOTATION_TPL_URL = "https://localhost:7267/AICC/Quotes";//"https://bcare-motor.aicc.com.sa:9443/api/Quotes";
        private const string QUOTATION_COMPREHENSIVE_URL = "https://localhost:7267/AICC/Quotes";//"https://bcare-comp.aicc.com.sa:4433/api/Quotes";
        ...
        //    try
        //    {
        //        //var testMode = _tameenkConfig.Policy.TestMode; by Atheer 
        //        if (testMode)
        //        {
